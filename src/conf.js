module.exports = {
  ...
  alwaysAppendedText: process.env.ALWAYS_APPENDED_TEXT !== 'undefined' && process.env.ALWAYS_APPENDED_TEXT !== undefined ? process.env.ALWAYS_APPENDED_TEXT: '',

  logins: process.env.LOGINS !== 'undefined' && process.env.LOGINS !== undefined ? process.env.LOGINS.split(',') : [],
}
